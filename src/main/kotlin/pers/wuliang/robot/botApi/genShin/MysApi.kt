package pers.wuliang.robot.botApi.genShin

import com.fasterxml.jackson.databind.JsonNode
import com.fasterxml.jackson.databind.ObjectMapper
import org.apache.hc.core5.http.io.entity.StringEntity
import pers.wuliang.robot.common.utils.HttpUtil
...
class MysApi(
    ...
    fun getData(type: String, data: MutableMap<String, Any> = mutableMapOf(), headersType: String? = null): JsonNode {
        ...
        val response: JsonNode = if (body != "") {
            HttpUtil.doPostJson(url = url, entity = StringEntity(body), header = headers)
        } else {
            HttpUtil.doGetJson(url = url, header = headers)
        }
